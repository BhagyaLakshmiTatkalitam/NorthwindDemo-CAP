		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ER PORTAL",
									"targetURL": "#errequestform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"errequestform-display": {
								"semanticObject": "errequestform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=errequestform",
									"url": sap.ui.require.toUrl("errequestform")
								}
							}
						}
					}
