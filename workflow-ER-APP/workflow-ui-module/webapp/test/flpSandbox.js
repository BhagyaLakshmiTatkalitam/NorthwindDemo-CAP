		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ER ApprovalForm",
									"targetURL": "#erworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"erworkflowuimodule-display": {
								"semanticObject": "erworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=er.workflowuimodule",
									"url": sap.ui.require.toUrl("er/workflowuimodule")
								}
							}
						}
					}
